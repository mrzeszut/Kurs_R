...
Jeśli chcesz dowiedzieć się torchę więcej o mnie to odwiedźć stronę [WWW](http://home.agh.edu.pl/~rzeszut/). Znjadziesz tam samouczki do pakietu `openair`, który służy do analizy danych z monitoringu jakości powietrza. Jeśli chcesz na te temat dowiedzieć się więcej to na III roku studiów, możesz zapisać się na [fakultet](https://syllabuskrk.agh.edu.pl/2018-2019/pl/magnesite/study_plans/stacjonarne-inzynieria-srodowiska--6/module/dis-1-715-s-pakiet-r-w-analizie-danych-srodowiskowych).
